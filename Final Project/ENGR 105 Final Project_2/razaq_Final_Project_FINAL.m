...
helpButton = uicontrol('Style','pushbutton','Units','Normalized','Position',...
 ...
 % create the help screen window
helpScreen = figure('visible','off');
g5=axes('units','normalized','position',[0,0,1,1]);
set(g5,'handlevisibility','off','visible','off')
g5_image = imagesc(map_image)
% turn tick marks off
set(gca,'xtick',[]);
set(gca,'ytick',[]);
uistack(g5,'bottom');
...
helpButton.Callback = {@helpMenu,h1,g5,helpScreen};
...
startButton.Callback = {@test_startGame,h1,g4,home,startButton,helpButton,t_redBalloons};
