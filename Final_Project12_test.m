...
while gameStillGoing
    ...
    if ~gameStillGoing 
        ...
        u1.Callback = {@resetGame_1,h1,redStartPos,redBalloonStep,blueStartPos...
            ,blueBalloonStep,damage,boundaryHealth,health,redBalloonVec, ... 
            blueBalloonVec,u1,@makeBalloon, @moveBalloon, @healthBar};
    end
end