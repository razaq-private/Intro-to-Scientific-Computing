...
% 
%     startButton.Callback = {@startGame,g3,startButton,helpButton};
% end

% if handles.homePage == false
    % ------------------------------------------
    % Graphics Code
...
%         h1.WindowButtonUpFcn = {@placeTower,towerBank};
        ...
        % move the balloons
        t_redBalloons = timer("TimerFcn",{@moveBalloon,h1,redBalloonVec,0,bananaScore,pointScore,damage},...
